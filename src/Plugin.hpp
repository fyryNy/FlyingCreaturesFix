namespace GOTHIC_NAMESPACE 
{
	...
	void __fastcall zCCollObjectCharacter_TestHardCollisions_Slope(::Union::Registers& reg)
	{
		...
		if (!npc || npc == player || (!EdgesFixAffectAllNpcs && !npc->IsFlyingCreature_Union()))
		{
			return;
		}
	...
	{
		EdgesFixAffectAllNpcs = zoptions->ReadBool("FlyingCreaturesFix", "EdgesFixAffectAllNpcs", false);
	}
